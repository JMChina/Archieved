...
static void append_referrer(weak_entry_t *entry, objc_object **new_referrer)
{
    ...
    // weak_entry是一个哈希表，key:w_hash_pointer(new_referrer) value:new_referrer
    ...
    // 将ref存入referrers数组中，同时更新元素个数num_refs
                      ...
                      id *referrer_id, bool crashIfDeallocating)
{
    ...
    // 在weak_table中找到referent对应的weak_entry，并将referrer加入到weak_entry中
    weak_entry_t *entry;
